export const dataArray = [
  ...
  {
    texto: 'Acompañamiento canal virtual',
    nivel1: [
      {
        texto: 'Zona pública',
        nivel2: [
  ...
  {
    texto: 'Actualización de datos de contacto - BH',
    nivel1: [
      {
